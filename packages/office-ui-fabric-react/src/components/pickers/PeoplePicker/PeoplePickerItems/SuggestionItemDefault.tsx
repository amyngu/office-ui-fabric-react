...
import { IBasePickerSuggestionsProps, ISuggestionItemProps, IPeoplePickerPersonaProps } from 'office-ui-fabric-react/lib/Pickers';
import * as stylesImport from '../PeoplePicker.scss';
const styles: any = stylesImport;

export const SuggestionItemCanExpand: (persona: IPeoplePickerPersonaProps, suggestionProps?: IBasePickerSuggestionsProps) => JSX.Element = (personaProps: IPersonaProps, suggestionItemProps?: ISuggestionItemProps<any>) => {
  return (
